...
const menu = {
    ...
    "Data Grid": { label: "Data Grid", value: "Data Grid", "icon": "grid-view-small"},
    "List of Values - LOV": { label: "List of Values", value: "List of Values - LOV", "icon": "text-input-combo"},
    "Chart": { label: "Chart", value: "Chart", "icon": "chart"},
    "Checkbox Set": { label: "Checkbox Set", value: "Checkbox Set", "icon": "checkbox-set"},
    "Editable Rows": { label: "Editable Rows", value: "Editable Rows", "icon": "tables-basic"},
    "Navigation": { label: "Navigation", value: "Navigation", "icon": "film-strip"},
  };
